...
- `/api/live-houdini-readings`, `/api/g5-surf-protocol` (G5 SURF · Node serverless, **`human_intervention_required: false`**, **no** `vercel.json` cron — invoke on demand), `/api/blank-stone-hydrogen`, etc.
