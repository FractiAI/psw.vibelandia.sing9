/**
 * SING 9 — no Supabase, no auth. Lite api-config for same-origin and optional PayPal.
...
/**
 * PayPal client ID — optional. Injected at build from VIBELANDIA_PAYPAL_CLIENT_ID or PAYPAL_CLIENT_ID.
 * When empty, PayPal Pipes UI can still reference; no serverless in Sing9.
 */
(function () {
  if (typeof window === 'undefined') return;
