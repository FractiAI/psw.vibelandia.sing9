...
// components/whiteboard/entry.tsx
var import_client = __toESM(require_client());

// components/whiteboard/MainCanvas.tsx
...
// components/whiteboard/DigitalPruViewport.tsx
...
function DigitalPruViewport({ nav, generativeSeed, transitionEpoch }) {
  ...
  const navRef = (0, import_react24.useRef)(nav);
  const seedRef = (0, import_react24.useRef)(generativeSeed);
  navRef.current = nav;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "relative h-full w-full overflow-hidden rounded-lg border border-cyan-400/30 bg-slate-950/80 shadow-[0_0_24px_rgba(34,211,238,0.25)]", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("canvas", { ref: canvasRef, className: "absolute inset-0 h-full w-full" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950/90 to-transparent p-3 text-left", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { className: "text-[10px] font-semibold uppercase tracking-[0.2em] text-cyan-200/90", children: [
        "GoPro Awareness \xB7",
        " ",
        nav.mode === "external" ? "External \xB7 Reno / Truckee" : "Internal \xB7 Holographic thought"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { className: "mt-1 truncate font-mono text-[11px] text-cyan-100/70", children: [
        "NAV \xB7 ",
        nav.x.toFixed(3),
        " \xB7 ",
        nav.y.toFixed(3),
...
// components/whiteboard/useAwarenessStream.ts
var import_react25 = __toESM(require_react());
var DEFAULT_API = "/api/egs-emulation";
function useAwarenessStream(apiBase = DEFAULT_API) {
  const [nav, setNav] = (0, import_react25.useState)({
    x: 0.5,
    y: 0.5,
    z: 0.25,
    conceptId: "ground",
  ...
  navRef.current = nav;
  const shiftTowardConcept = (0, import_react25.useCallback)(
    async (conceptId) => {
...
function MainCanvas() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "mb-4 rounded-xl border border-amber-400/25 bg-slate-900/40 p-3 backdrop-blur-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-wrap items-center gap-2 border-b border-cyan-500/10 pb-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[10px] font-bold uppercase tracking-widest text-slate-400", children: "Whiteboard" }),
...
var el = document.getElementById("digital-pru-root");
if (el) {
  (0, import_client.createRoot)(el).render(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)(MainCanvas, {}));
}
...
react/cjs/react-jsx-runtime.production.min.js:
   ...
   *)
*/
//# sourceMappingURL=digital-pru-whiteboard.js.map
