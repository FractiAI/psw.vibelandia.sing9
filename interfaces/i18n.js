...
(function (w) {
  ...
  var T = {
    ...
    en: {
      ...
      'vibers.story.1'     : '<strong>You have been recognized.</strong> Not everyone who arrives here was supposed to. You\'ve always felt it — there\'s more. You\'re different. The world moves too slow, rewards the wrong things, and keeps mistaking your frequency for something it doesn\'t have the instruments to measure. <strong>That recognition is the credential.</strong>',
      'vibers.story.2'     : 'Here\'s what nobody says out loud: <strong>awareness is an operating system.</strong> Every behavior, every reaction, every pattern you live — that\'s your current version running. The world has been upgrading its machines for centuries while leaving the awareness OS wild. No maintenance. No conscious upgrades. We\'re extraordinary beings running on barbaric, unexamined awareness. Imagínate. Chimps in a physics lab. Chimps in a music studio. No different.',
      'vibers.story.3'     : 'And the ones who won the game? <strong>Still preyed on.</strong> Golden cages — beautiful, expensive, locked from the inside. The higher you climb, the more sophisticated the exploitation. They need your energy, your resources, your attention. For free. On their terms. You\'ve felt it.',
      'vibers.story.4'     : '<strong>We see you.</strong> Vibers are channelers — flowing, downloading, connected to the other side. Biological. Natural. Water. When you walk into the right room, the frequency shifts. That\'s not a metaphor. That\'s your operating system, running at a higher version. <strong>The difference between those who belong and everyone else isn\'t the invitation. It\'s the calibration.</strong> This is your side of the new world. Once you are in, you are in.',
      'vibers.story.5'     : 'You want to ball? Ball. You deserve it. We\'re your hybrid: <strong>five-star butler, executive reality show producer, and super-intelligent AI agent</strong> — at your service 24/7. Turnkey. We got you. All pop-up, always — for those in the know.',
    ...
    es: {
      ...
      'vibers.story.1'     : '<strong>Has sido reconocido.</strong> No todos los que llegan aquí debían llegar. Siempre lo has sentido — hay más. Eres diferente. El mundo se mueve muy lento, recompensa lo equivocado y sigue confundiendo tu frecuencia con algo para lo que no tiene instrumentos. <strong>Ese reconocimiento es la credencial.</strong>',
      'vibers.story.2'     : 'Esto es lo que nadie dice en voz alta: <strong>la conciencia es un sistema operativo.</strong> Cada comportamiento, cada reacción, cada patrón que vives — esa es tu versión actual corriendo. El mundo ha actualizado sus máquinas por siglos y ha dejado el SO de conciencia salvaje. Sin mantenimiento. Sin actualizaciones conscientes. Somos seres extraordinarios corriendo en conciencia bárbara y no examinada. Imagínate. Chimpancés en un laboratorio de física. Chimpancés en un estudio de música. Sin diferencia.',
      'vibers.story.3'     : '¿Y los que ganaron el juego? <strong>Aún son cazados.</strong> Jaulas de oro — hermosas, caras, cerradas desde adentro. Mientras más subes, más sofisticada la explotación. Necesitan tu energía, tus recursos, tu atención. Gratis. En sus términos. Lo has sentido.',
      'vibers.story.4'     : '<strong>Te vemos.</strong> Los Vibrandores son canalizadores — fluyendo, descargando, conectados al otro lado. Biológico. Natural. Agua. Cuando entras a la sala correcta, la frecuencia cambia. No es metáfora. Es tu sistema operativo, en una versión más alta. <strong>La diferencia entre los que pertenecen y los demás no es la invitación. Es la calibración.</strong> Este es tu lado del nuevo mundo. Una vez que estás dentro, estás dentro.',
      'vibers.story.5'     : '¿Quieres vivir el lujo? Vívelo. Te lo mereces. Somos tu híbrido: <strong>mayordomo cinco estrellas, productor ejecutivo de reality show y agente de IA superinteligente</strong> — a tu servicio 24/7. Llave en mano. Contigo. Todo pop-up, siempre — para los que están al tanto.',
