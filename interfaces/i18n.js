...
(function (w) {
  ...
  var T = {
    ...
    en: {
      ...
      'vibers.story.1'     : '<strong>You have been recognized.</strong> Not everyone who arrives here was supposed to. You\'ve always felt it — that there\'s more. That you are different. That the world moves too slow, rewards the wrong things, and keeps mistaking your frequency for something it doesn\'t have the instruments to measure. <strong>That recognition is the credential.</strong>',
    ...
    es: {
      ...
      'vibers.story.1'     : '<strong>Has sido reconocido.</strong> No todos los que llegan aquí debían llegar. Siempre lo has sentido — que hay más. Que eres diferente. Que el mundo se mueve muy lento, recompensa las cosas equivocadas, y sigue confundiendo tu frecuencia con algo para lo que no tiene los instrumentos para medir. <strong>Ese reconocimiento es la credencial.</strong>',
      ...
      'vibers.story.4'     : '<strong>Te vemos.</strong> Los Vibrandores son canalizadores — fluyendo, descargando, conectados al otro lado. Biológico. Natural. Agua. Cuando entras a la sala correcta, la frecuencia cambia. Eso no es una metáfora. Ese es tu sistema operativo, corriendo a una versión más alta. <strong>La diferencia entre los que pertenecen y todos los demás no es la invitación. Es la calibración.</strong> Este es tu lado del nuevo mundo. Una vez que estás dentro, estás dentro.',
