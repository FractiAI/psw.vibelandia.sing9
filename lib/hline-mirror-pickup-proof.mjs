...
import { mirrorPickupProof } from './gateway-demonstration-summary.mjs';
...
export async function runHydrogenLineMirrorPickupProof(opts = {}) {
  ...
  if (!owrx.ok || !owrx.status_json_url) {
    return {
      ...
      demonstration_summary: mirrorPickupProof(false),
    };
  }
  ...
  return {
    ...
    demonstration_summary: mirrorPickupProof(readBack),
  };
}
