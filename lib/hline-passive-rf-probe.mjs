...
import { passiveRfTier0 } from './gateway-demonstration-summary.mjs';
...
export async function runPassiveRfEngineeringProbeTier0(opts = {}) {
  ...
  const geomPass = allGeometryChecksPass === true;
  ...
  return {
    ...
    demonstration_summary: passiveRfTier0(geomPass, httpSuccessCount),
  };
}
